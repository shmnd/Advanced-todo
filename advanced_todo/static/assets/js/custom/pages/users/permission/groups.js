...
// Class definition
const DatatablesAndCRUDOperationServerSide = function() {
            ...
            columnDefs: [
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        let perm_value = document.getElementById("check_perm").value
                        if(perm_value){
                        ...
                        return `
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a href="javascript:void(0)" data-id=${row.id} data-groups-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
                                        <span class="svg-icon svg-icon-3">
