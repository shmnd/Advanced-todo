...
// Class definition
let DatatablesServerSide = function() {
    // Shared variables
    let table;
    let dt;
            ...
            columnDefs: [
                ...
                
                {
                    ...
                    render: function (data,type, row) {
                        ...
                        if (data == 'True') {
                            label_badge_change = 'Active';
                            buttonClass = 'btn-outline-success';
                        } else if (data == 'False') {
                            label_badge_change = 'Inactive';
                            buttonClass = 'btn-outline-danger';
                        }
                
                        return `<button type="button" style="cursor:pointer; padding: 0.2rem 0.4rem; font-size: 0.8rem;" data-id="${row.id}" class="btn ${buttonClass} active_inactive_language">${label_badge_change}</button>`;
                    }
                },

                {
                    ...
                    targets: 4,
                    render: function (data, type, row) {
                        if (row.order === "None" || row.order === null || row.order === undefined) {
                            return ''; 
                        }
    ...
    let initToggleToolbar = function() {
        ...
        if (deleteSelected) {
                ...
                console.log('Delete selected button not found');
                // Handle case where delete button does not exist
            }
        };
