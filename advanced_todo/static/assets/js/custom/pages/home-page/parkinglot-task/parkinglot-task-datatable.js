...
const DatatablesServerSide = function() {
    ...
    let initDatatable = function() {
        ...
        dt = $("#parkinglot-task-datatable").DataTable({
            searchDelay: 500,
            serverSide: true,
            responsive: true,
            processing: true,
        ...
        activeButton.forEach(d => {
            d.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if(result.value){               
                        $.post(`${api_config.active_inactive_task}`, {id:activeId }, function(data, status, xhr) {
    ...
    let initToggleToolbar = function() {
        ...
        const container = document.querySelector('#parkinglot-task-datatable');
